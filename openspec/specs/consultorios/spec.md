...
Configuración de consultorio de médico (CU 7): catálogo numerado persistido, asignación 1:1 médico↔consultorio desde `/consultorios` (Administrador y Recepcionista), contratos `GET`/`PATCH /api/consultorios`, confirmación al reasignar o desasignar, layout multi-columna y feedback sin toast de éxito.
