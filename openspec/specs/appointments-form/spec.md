...
Popup modal reutilizable para crear, visualizar y editar turnos desde la Agenda (`/agenda`): formulario con validación, lookup de paciente por documento, combobox cruzados médico/especialidad, alta transaccional y contratos de escritura/detalle en el backend.
