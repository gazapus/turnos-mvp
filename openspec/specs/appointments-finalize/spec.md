...
Finalización de turno (CU 9/10): el Médico pasa un turno propio `CONFIRMADO` del día civil de clínica a `ATENDIDO` si ya hubo al menos un llamado, desde Lista o popup, con contrato `PATCH /api/turnos/:id/finalizar`.
