...
Asistente de documentación de uso de la aplicación: corpus markdown de ayuda, grafo LangGraph restringido al dominio (sin tools ni datos operativos) y contrato HTTP autenticado `POST /api/chatbot/mensajes`.
