...
Primitivas de feedback transversal para el shell autenticado: toast de éxito genérico y dialog de error genérico, reutilizables desde cualquier pantalla (incluido el popup de turnos).
