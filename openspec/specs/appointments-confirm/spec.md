...
Confirmación de turno (CU 4): transición `PROGRAMADO → CONFIRMADO` el día civil de clínica, desde el listado o el popup de detalle, con contrato `PATCH /api/turnos/:id/confirmar`, visibilidad del control y feedback.
